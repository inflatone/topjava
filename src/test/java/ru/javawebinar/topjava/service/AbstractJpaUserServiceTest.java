...
public abstract class AbstractJpaUserServiceTest extends AbstractUserServiceTest {
    ...
    public void testValidation() throws Exception {
        ...
        validateRootCause(() -> service.create(new User(null, "User", "mail@yadex.ru", "password", 10001, true, new Date(), Collections.emptySet())), ConstraintViolationException.class);
    }
}
